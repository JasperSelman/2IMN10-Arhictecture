...
Now we are going to analyze the architecture proposed in \cite{service} with to performance properties like maintenance, load distribution, security, availability, usability and scalability. 
